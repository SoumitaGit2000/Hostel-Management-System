...
if(isset($_POST["submit"]))
{
    ...
    $result = mysqli_query($conn, "SELECT * FROM sregistration WHERE email = '$email'");
            ...
            <div class="offset-1">
                <div class ="row align-items-center">
                    <div class="col-8 text-capitalize">
                        <h1 class="display-5 font-weight-bold"><font size="25">Student Login</font></h1>
                        <hr class="my-4">
                        <div class="d-inline-flex">
                            ...
                            <p class="m-0 text-uppercase"><a class="text-white" href="slogin.php"><h4>Student Login</h4></a></p>
                        </div>
            ...
            <div class ="container mt-5">
                <div class = "row">
                    <div class="container mt-6">
                        <h1 class="font-weight-bold py-3"><center>Student Login</center></h1>
                        <br>
